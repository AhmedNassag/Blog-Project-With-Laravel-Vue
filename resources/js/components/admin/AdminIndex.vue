                        ...
                        <tbody v-if="posts.length">
                            <tr v-for="(post,index) in posts" :key="index">
                                <td class="text-center">
                                    <span class="custom-checkbox">
                                        <input type="checkbox" :id="'checkbox1'+index" @click.stop="selectPost(post,$event)" name="options[]" value="1">
                                        <label :for="'checkbox1'+index"></label>
                                    </span>
                                </td>
                                <td class="text-center">{{post.title}}</td>
                                <td class="text-center">{{post.body.substr(0,150)}}</td>
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    <router-link :to="'/post/'+post.slug" class="" target="_blank"><i class="material-icons" data-toggle="tooltip" title="Show">&#128065;</i></router-link>
                                    <a href="#editPostModal" class="edit" data-toggle="modal" @click.prevent="editPost(post,$event)"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <!-- <a href="#deletePostModal" class="delete" data-toggle="modal" @click.prevent="deletePosts(post,$event)"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a> -->
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="modal-content">
                        <form>
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="submit" class="btn btn-danger" value="Delete" @click.prevent="deletePosts">
                            </div>
                        </form>
                    </div>
                </div>
